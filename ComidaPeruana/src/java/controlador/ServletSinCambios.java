 ...
 * @author Fabian
 */
@WebServlet(name = "ServletSinCambios", urlPatterns = {"/ServletSinCambios"})
public class ServletSinCambios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String rut_cliente = request.getParameter("alCarro");
        ...
        try {
            ...
            sesion.setAttribute("alCarro", rut_cliente);
